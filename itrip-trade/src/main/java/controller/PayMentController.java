...
public class PayMentController {
    ...
    public void pay(
        ...
        String orderno=new String(WIDout_trade_no.getBytes("ISO-8859-1"),"UTF-8");
    ...
    public void trackPaymentStatus(HttpServletRequest request,
        ...
        try {
            ...
            ItripHotelOrder itripHotelOrder=orderService.selHotelOrder(out_trade_no,0);
            if (verify_result) {// 验证成功
                ...
                if (trade_status.equals("TRADE_FINISHED")) {
                    ...
                    System.out.println("订单："+out_trade_no+" 交易成功");
                    // 注意：
    ...
    public void callback(HttpServletRequest request,
        ...
        try {
            ...
            ItripHotelOrder itripHotelOrder=orderService.selHotelOrder(out_trade_no,0);
            if(verify_result){//验证成功
                String id=orderService.selHotelOrder(out_trade_no,0).getId().toString();
                itripHotelOrder.setTradeNo(trade_no);
                itripHotelOrder.setOrderStatus(2);
                itripHotelOrder.setPayType(1);
                itripHotelOrder.setModifyDate(new Date());
                ...
                itripHotelOrder.setModifyDate(new Date());
                orderService.modifyHotelOrder(itripHotelOrder);
                roomService.modifyTempStroecount(itripHotelOrder.getHotelId().intValue(),itripHotelOrder.getRoomId().intValue(),itripHotelOrder.getCheckInDate(),itripHotelOrder.getCheckOutDate(),out_trade_no,false);
    ...
    @RequestMapping(value = "/ali/success")
    public String success(){
        return "success";
    }
    @RequestMapping(value = "/ali/fail")
    public String fail(){
        return "failure";
    }
}
